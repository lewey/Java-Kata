...
public class IntersectionTypesCast
{
    ...
    {
        // we can make use of the intersection cast here to add serializable together with Runnable
    ...
    private static void writeToFile(final File file, Object object) throws IOException
    {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(file))) {
            // this would throw a notSerializable exception if the lambda was passed in without the intersection of serializable
