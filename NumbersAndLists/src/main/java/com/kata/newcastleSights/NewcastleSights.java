...
public class NewcastleSights {
    ...
    private static final List<String> KNOWN_SIGHTS = List.of("St James park", "Big Market", "Tyne Bridge", "Monument", "Millennium Bridge", "The Sage", "Theatre Royal", "Greggs Sausage Roll");
