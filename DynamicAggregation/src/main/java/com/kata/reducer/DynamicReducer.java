...
public class DynamicReducer {

    public static Map<String, FundData> reduce(List<FundData> fundDataList){
        return fundDataList.stream().collect(groupingBy(FundData::getDynamicGroupByKey, reducing(new FundData(), DynamicReducer::reduceParts)));
    }
